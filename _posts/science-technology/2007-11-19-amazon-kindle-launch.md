...
- consumer gadgets
- digital media
excerpt: Amazon introduced the first-generation Kindle e-reader on November 19, 2007, at a press event in New York City. Jeff Bezos unveiled the device at a price of $399, and it sold out within 5.5 hours of going on sale. The device featured a 6-inch E Ink electronic paper display (600 × 800 pixels at 167…
preview: "/images/previews/science-technology.svg"
permalink: "/news/science-technology/amazon-kindle-launch/"
---
...
The project remained secret for more than three years of development. When Bezos announced it at a press event at the W Hotel on Union Square in New York on November 19, 2007 — two weeks into the [Writers Guild of America strike]({{ '/news/arts-culture/writers-guild-strike/' | relative_url }}) — it was the company's most significant hardware product reveal.
...
The Kindle launched just five months after the [iPhone]({{ '/news/science-technology/iphone-launch/' | relative_url }}), and the two devices together defined a new paradigm in consumer electronics: sophisticated mobile screens that served as platforms for media consumption. When Apple launched the App Store in July 2008, it incorporated Kindle's core insight — that hardware and seamless content purchase could form a single integrated experience — into a broader application ecosystem. The launch is widely regarded as one of the most consequential consumer electronics introductions of the 2000s.

## Sources

- [Amazon Kindle - Wikipedia](https://en.wikipedia.org/wiki/Amazon_Kindle)
