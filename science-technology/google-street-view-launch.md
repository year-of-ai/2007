...
Street View images were rendered in users' browsers via a plugin-free Flash-based viewer in 2007, before later transitioning to WebGL and HTML5. The launch predated widespread smartphone adoption (the [iPhone Launch](iphone-launch.md) occurred just five weeks after Street View's debut), so the initial product targeted desktop web users. Mobile Street View access would become a major use case after iOS and Android integration in subsequent years.
...
The privacy tensions introduced in 2007 established a template for subsequent debates about ubiquitous data collection. Street View's controversies foreshadowed the larger privacy discourse around location data, facial recognition, and public surveillance that dominated technology policy discussions throughout the 2010s (see [Facebook Platform](facebook-platform.md) for the concurrent emergence of social-graph data collection). The launch of Street View just five weeks before the iPhone made smartphones mainstream illustrated how 2007 marked the hinge year when the internet became both spatially comprehensive and personally mobile.

## Related Topics

- [iPhone Launch](iphone-launch.md) — launched five weeks after Street View; later integrated Street View into Apple Maps and mobile navigation
- [YouTube's Rise as Global Media Platform in 2007](youtube-growth-2007.md) — parallel Google-era transformation of the web into an immersive visual medium
- [Facebook Platform](facebook-platform.md) — concurrent emergence of large-scale personal data collection and associated privacy debates
...
- [iPhone Launch](iphone-launch.md) — Launched five weeks after Street View; later integrated it into mobile navigation.
- [Facebook Platform Launch](facebook-platform.md) — Concurrent emergence of large-scale personal-data collection and privacy debates.
- [YouTube's Rise as Global Media Platform](youtube-growth-2007.md) — Parallel Google-era transformation of the web into an immersive visual medium.
